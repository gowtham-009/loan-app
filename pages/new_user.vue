   ...
   <div class="main_container w-100" :style="{height: deviceHeight + 'px'}">
        ...
        <div class="box-2 w-100 d-flex flex-column" :style="{height:boxex2Height + 'px'}">
          <div class="w-100 d-flex">
            <div class="w-100">
                  <v-btn variant="plain" class="text-blue text-caption" block>New User</v-btn>
                </div>
                <div class="w-100">
                  <v-btn variant="plain" class="bg-deep-purple-accent-3 text-white text-caption" block>Search User</v-btn>
                </div>
          </div>
          <div class="w-100">
        ...
        <div class="w-100 d-flex ga-2 align-center" :style="{height:boxex3Height + 'px'}">
          <div class="w-100"><v-btn class="bg-yellow text-black" block>Reset</v-btn></div>
        <div class="w-100"><v-btn class="bg-green text-white" block>Next</v-btn></div>
        </div>
   </div>
  </div>
</template>
